...
if ($pathsOk) {
	...
	Invoke-Check -Name "Backend Cloudflare Worker V8 bindings & types (wrangler types)" -WorkingDirectory $BackendDir -FilePath $npxCommand.Source -Arguments @("wrangler", "types")
